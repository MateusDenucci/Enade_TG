...
for curso in cursos:
	...
	for etnia in etnias:
		return_fg,return_ce,return_ger = getData(etnia,etnia,curso,"",126,"Todo em escola publica.")
	...
	for etnia in etnias:
		return_fg,return_ce,return_ger = getData(etnia,etnia,curso,"",126,"Todo em escola privada (particular).")
		fh_saida_fg.write(calculaMediana(return_fg)+"\t")
		fh_saida_ce.write(calculaMediana(return_ce)+"\t")
		fh_saida_ger.write(calculaMediana(return_ger)+"\t")
	for etnia in etnias:
		return_fg,return_ce,return_ger = getData(etnia,etnia,curso,"federal",126,"Todo em escola publica.")
		fh_saida_fg.write(calculaMediana(return_fg)+"\t")
		fh_saida_ce.write(calculaMediana(return_ce)+"\t")
		fh_saida_ger.write(calculaMediana(return_ger)+"\t")
	for etnia in etnias:
		return_fg,return_ce,return_ger = getData(etnia,etnia,curso,"privada",126,"Todo em escola privada (particular).")
		fh_saida_fg.write(calculaMediana(return_fg)+"\t")
		fh_saida_ce.write(calculaMediana(return_ce)+"\t")
		fh_saida_ger.write(calculaMediana(return_ger)+"\t")
	for etnia in etnias:
		return_fg,return_ce,return_ger = getData(etnia,etnia,curso,"privada",117,"De 1;5 a 3 salarios minimos (R$ 1.086;01 a R$ 2.172;00).")
		fh_saida_fg.write(calculaMediana(return_fg)+"\t")
		fh_saida_ce.write(calculaMediana(return_ce)+"\t")
		fh_saida_ger.write(calculaMediana(return_ger)+"\t")
	for etnia in etnias:
		return_fg,return_ce,return_ger = getData(etnia,etnia,curso,"privada",117,"De 10 a 30 salarios minimos (R$ 7.240;01 a R$ 21.720;00).")
		fh_saida_fg.write(calculaMediana(return_fg)+"\t")
		fh_saida_ce.write(calculaMediana(return_ce)+"\t")
		fh_saida_ger.write(calculaMediana(return_ger)+"\t")
	for etnia in etnias:
		return_fg,return_ce,return_ger = getData(etnia,etnia,curso,"federal",117,"De 1;5 a 3 salarios minimos (R$ 1.086;01 a R$ 2.172;00).")
		fh_saida_fg.write(calculaMediana(return_fg)+"\t")
		fh_saida_ce.write(calculaMediana(return_ce)+"\t")
		fh_saida_ger.write(calculaMediana(return_ger)+"\t")
	for etnia in etnias:
		return_fg,return_ce,return_ger = getData(etnia,etnia,curso,"federal",117,"De 10 a 30 salarios minimos (R$ 7.240;01 a R$ 21.720;00).")
		fh_saida_fg.write(calculaMediana(return_fg)+"\t")
		fh_saida_ce.write(calculaMediana(return_ce)+"\t")
		fh_saida_ger.write(calculaMediana(return_ger)+"\t")
	for etnia in etnias:
		return_fg,return_ce,return_ger = getData(etnia,etnia,curso,"privada",0,"")
		fh_saida_fg.write(calculaMediana(return_fg)+"\t")
		fh_saida_ce.write(calculaMediana(return_ce)+"\t")
		fh_saida_ger.write(calculaMediana(return_ger)+"\t")
	for etnia in etnias:
		return_fg,return_ce,return_ger = getData(etnia,etnia,curso,"privada",124,"Sim; por criterio etnico-racial.")
		fh_saida_fg.write(calculaMediana(return_fg)+"\t")
		fh_saida_ce.write(calculaMediana(return_ce)+"\t")
		fh_saida_ger.write(calculaMediana(return_ger)+"\t")
	for etnia in etnias:
		return_fg,return_ce,return_ger = getData(etnia,etnia,curso,"federal",0,"")
		fh_saida_fg.write(calculaMediana(return_fg)+"\t")
		fh_saida_ce.write(calculaMediana(return_ce)+"\t")
		fh_saida_ger.write(calculaMediana(return_ger)+"\t")
		
	return_fg,return_ce,return_ger = getData(fh_brancos,"Branco(a).",curso,"federal",124,"Nao.")
	fh_saida_fg.write(calculaMediana(return_fg)+"\t")
	fh_saida_ce.write(calculaMediana(return_ce)+"\t")
	fh_saida_ger.write(calculaMediana(return_ger)+"\t")
	
	return_fg,return_ce,return_ger = getData(fh_brancos,"Branco(a).",curso,"federal",124,"Sim; por criterio de renda.")
	fh_saida_fg.write(calculaMediana(return_fg)+"\t")
	fh_saida_ce.write(calculaMediana(return_ce)+"\t")
	fh_saida_ger.write(calculaMediana(return_ger)+"\t")
	
	return_fg,return_ce,return_ger = getData(fh_brancos,"Branco(a).",curso,"federal",124,"Sim; por ter estudado em escola publica ou particular com bolsa de estudos.")
	fh_saida_fg.write(calculaMediana(return_fg)+"\t")
	fh_saida_ce.write(calculaMediana(return_ce)+"\t")
	fh_saida_ger.write(calculaMediana(return_ger)+"\t")
	...
	etnias.pop(0)
	for etnia in etnias:
		return_fg,return_ce,return_ger = getData(etnia,etnia,curso,"federal",124,"Nao.")
		fh_saida_fg.write(calculaMediana(return_fg)+"\t")
		fh_saida_ce.write(calculaMediana(return_ce)+"\t")
		fh_saida_ger.write(calculaMediana(return_ger)+"\t")
		
		return_fg,return_ce,return_ger = getData(etnia,etnia,curso,"federal",124,"Sim; por ter estudado em escola publica ou particular com bolsa de estudos.")
		fh_saida_fg.write(calculaMediana(return_fg)+"\t")
		fh_saida_ce.write(calculaMediana(return_ce)+"\t")
		fh_saida_ger.write(calculaMediana(return_ger)+"\t")

		return_fg,return_ce,return_ger = getData(etnia,etnia,curso,"federal",124,"Sim; por criterio etnico-racial.")
		fh_saida_fg.write(calculaMediana(return_fg)+"\t")
		fh_saida_ce.write(calculaMediana(return_ce)+"\t")
		fh_saida_ger.write(calculaMediana(return_ger)+"\t")
		
		return_fg,return_ce,return_ger = getData(etnia,etnia,curso,"federal",124,"Sim; por criterio de renda.")
		fh_saida_fg.write(calculaMediana(return_fg)+"\t")
		fh_saida_ce.write(calculaMediana(return_ce)+"\t")
		fh_saida_ger.write(calculaMediana(return_ger)+"\t")
	...
	for etnia in etnias:
		return_fg,return_ce,return_ger = getData(etnia,etnia,curso,"federal",126,"Todo em escola privada (particular).")
		fh_saida_fg.write(calculaMediana(return_fg)+"\t")
		fh_saida_ce.write(calculaMediana(return_ce)+"\t")
		fh_saida_ger.write(calculaMediana(return_ger)+"\t")
	
	for etnia in etnias:
		return_fg,return_ce,return_ger = getData(etnia,etnia,curso,"privada",126,"Todo em escola publica.")
		fh_saida_fg.write(calculaMediana(return_fg)+"\t")
		fh_saida_ce.write(calculaMediana(return_ce)+"\t")
		fh_saida_ger.write(calculaMediana(return_ger)+"\t")
	...
	for etnia in etnias:
		return_fg,return_ce,return_ger = getDataDuplo(etnia,etnia,curso,"federal",126,"Todo em escola privada (particular).",124,"Nao.")
		fh_saida_fg.write(calculaMediana(return_fg)+"\t")
		fh_saida_ce.write(calculaMediana(return_ce)+"\t")
		fh_saida_ger.write(calculaMediana(return_ger)+"\t")
	fh_saida_fg.write("\n")
